...
#
# 	iex (New-Object Net.WebClient).DownloadString("%%GithubURL%%/raw/master/Install.ps1")

# Some general variables
$ModuleName = '%%ModuleName%%'	# Example: mymodule
$GithubURL = '%%GithubURL%%'	# Example: https://www.github.com/zloeber/mymodule
